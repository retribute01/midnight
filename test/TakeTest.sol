...
contract TakeTest is BaseTest {
    ...
    function testTakePostMaturity(uint256 maturity) public {
        ...
        terms.take(term, 100, 0, 0, lender, offer, sig, address(0), hex"");
    }

    function testLend() public {
        terms.take(term, 100, 0, 0, lender, borrowOffer, sig(borrowOffer, borrowerSK), address(0), hex"");
    ...
    function testBorrow() public {
        terms.take(term, 100, 0, 0, borrower, lendOffer, sig(lendOffer, lenderSK), address(0), hex"");
    ...
    function testWithdrawSecondaryWithLender() public {
        ...
        terms.take(term, 100, 0, 0, lender, lendOffer, sig(lendOffer, otherLenderSK), address(0), hex"");
    ...
    function testWithdrawSecondaryWithBorrower() public {
        ...
        lendOffer.nonce = 1;
        terms.take(term, 100, 0, 0, lender, lendOffer, sig(lendOffer, borrowerSK), address(0), hex"");
    ...
    function testRepaySecondaryWithBorrower() public {
        ...
        terms.take(term, 100, 0, 0, borrower, borrowOffer, sig(borrowOffer, otherBorrowerSK), address(0), hex"");
    ...
    function testRepaySecondaryWithLender() public {
        ...
        borrowOffer.nonce = 1;
        terms.take(term, 100, 0, 0, borrower, borrowOffer, sig(borrowOffer, lenderSK), address(0), hex"");
    ...
    function testMatch() public {
        terms.take(term, 100, 0, 0, address(this), borrowOffer, sig(borrowOffer, borrowerSK), address(0), hex"");
        terms.take(term, 100, 0, 0, address(this), lendOffer, sig(lendOffer, lenderSK), address(0), hex"");
    ...
    function testTakeOCO() public {
        ...
        terms.take(term, 70, 0, 0, borrower, lendOffer, sig(lendOffer, lenderSK), address(0), hex"");

        vm.expectRevert("consumed");
        terms.take(term2, 31, 0, 0, borrower, lendOffer2, sig(lendOffer2, lenderSK), address(0), hex"");

        terms.supplyCollateral(term2, address(collateralToken1), 134, borrower);

        terms.take(term2, 30, 0, 0, borrower, lendOffer2, sig(lendOffer2, lenderSK), address(0), hex"");
        assertEq(terms.consumed(lender, 0), 100);
    }
    ...
    function testTakeLendBorrowCallback() public {
        ...
        terms.take(term, 100, 0, 0, lender, borrowOffer, sig(borrowOffer, otherBorrowerSK), address(0), hex"");
    ...
    function testTakeBorrowLendCallback() public {
        ...
        terms.take(term, 100, 0, 0, borrower, lendOffer, sig(lendOffer, otherLenderSK), address(0), hex"");
    ...
    function testTakeMaturityPassed() public {
        ...
        vm.expectRevert("bond maturity");
        terms.take(term, 100, 0, 0, lender, lendOffer, sig(lendOffer, lenderSK), address(0), hex"");
    }
    ...
    function testTakeWrongSignature(Offer memory _offer) public {
        ...
        terms.take(term, 100, 0, 0, borrower, lendOffer, sig(_offer, lenderSK), address(0), hex"");
    }

    function testTakeInvalidSignature() public {
        vm.expectRevert("Invalid signature");
        terms.take(term, 100, 0, 0, borrower, lendOffer, Signature(0, 0, 0), address(0), hex"");
    }
}
