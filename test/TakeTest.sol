...
contract TakeTest is BaseTest {
    ...
    function testTakePostMaturity(uint256 maturity) public {
        ...
        morphoV2.take(obligation, 100, 0, 0, lender, offer, sig, address(0), hex"");
    }

    function testLend() public {
        morphoV2.take(obligation, 100, 0, 0, lender, borrowOffer, sig(borrowOffer, borrowerSK), address(0), hex"");
    ...
    function testBorrow() public {
        morphoV2.take(obligation, 100, 0, 0, borrower, lendOffer, sig(lendOffer, lenderSK), address(0), hex"");
    ...
    function testWithdrawSecondaryWithLender() public {
        ...
        morphoV2.take(obligation, 0, 0, 101, lender, lendOffer, sig(lendOffer, otherLenderSK), address(0), hex"");
    ...
    function testWithdrawSecondaryWithBorrower() public {
        ...
        lendOffer.nonce = 1;
        morphoV2.take(obligation, 0, 0, 101, lender, lendOffer, sig(lendOffer, borrowerSK), address(0), hex"");
    ...
    function testRepaySecondaryWithBorrower() public {
        ...
        morphoV2.take(
            obligation, 100, 0, 0, borrower, borrowOffer, sig(borrowOffer, otherBorrowerSK), address(0), hex""
        );
    ...
    function testRepaySecondaryWithLender() public {
        ...
        borrowOffer.nonce = 1;
        morphoV2.take(obligation, 100, 0, 0, borrower, borrowOffer, sig(borrowOffer, lenderSK), address(0), hex"");
    ...
    function testMatch() public {
        morphoV2.take(
            obligation, 100, 0, 0, address(this), borrowOffer, sig(borrowOffer, borrowerSK), address(0), hex""
        );
        morphoV2.take(obligation, 0, 0, 101, address(this), lendOffer, sig(lendOffer, lenderSK), address(0), hex"");
    ...
    function testTakePartialFill() public {
        morphoV2.take(obligation, 50, 0, 0, borrower, lendOffer, sig(lendOffer, lenderSK), address(0), hex"");

        assertEq(morphoV2.consumed(lender, 0), 50);

        vm.expectRevert("consumed");
        morphoV2.take(obligation, 51, 0, 0, borrower, lendOffer, sig(lendOffer, lenderSK), address(0), hex"");
    ...
    function testTakeOCO() public {
        ...
        morphoV2.take(obligation, 70, 0, 0, borrower, lendOffer, sig(lendOffer, lenderSK), address(0), hex"");

        vm.expectRevert("consumed");
        morphoV2.take(obligation2, 31, 0, 0, borrower, lendOffer2, sig(lendOffer2, lenderSK), address(0), hex"");

        morphoV2.supplyCollateral(obligation2, address(collateralToken1), 134, borrower);

        morphoV2.take(obligation2, 30, 0, 0, borrower, lendOffer2, sig(lendOffer2, lenderSK), address(0), hex"");
        assertEq(morphoV2.consumed(lender, 0), 100);
    }
    ...
    function testTakeLendBorrowCallback() public {
        ...
        morphoV2.take(obligation, 100, 0, 0, lender, borrowOffer, sig(borrowOffer, otherBorrowerSK), address(0), hex"");
    ...
    function testTakeBorrowLendCallback() public {
        ...
        morphoV2.take(obligation, 100, 0, 0, borrower, lendOffer, sig(lendOffer, otherLenderSK), address(0), hex"");
    ...
    function testTakeMaturityPassed() public {
        ...
        vm.expectRevert("maturity");
        morphoV2.take(obligation, 100, 0, 0, lender, lendOffer, sig(lendOffer, lenderSK), address(0), hex"");
    }
    ...
    function testTakeWrongSignature(Offer memory _offer) public {
        ...
        morphoV2.take(obligation, 100, 0, 0, borrower, lendOffer, sig(_offer, lenderSK), address(0), hex"");
    }

    function testTakeInvalidSignature() public {
        vm.expectRevert("Invalid signature");
        morphoV2.take(obligation, 100, 0, 0, borrower, lendOffer, Signature(0, 0, 0), address(0), hex"");
    }
