...
methods {
    ...
    function _.onSell(bytes32 id, Midnight.Market market, address seller, address receiver, uint256 sellerAssets, uint256 units, uint256 pendingFeeDecrease, bytes data) external => genericCallbackBytes32() expect(bytes32);
    ...
    function _.onLiquidate(bytes32 id, Midnight.Market market, address liquidator, address borrower, address receiver, uint256 collateralIndex, uint256 seizedAssets, uint256 repaidUnits, uint256 badDebt, bytes data) external => genericCallbackBytes32() expect(bytes32);
