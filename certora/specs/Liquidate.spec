...
methods {
    ...
    function isHealthyExternal(Midnight.Obligation obligation, bytes32 id, address borrower) external returns (bool);
...
rule liquidateRequireUnhealthy(env e, Midnight.Obligation obligation, uint256 collateralIndex, uint256 seizedAssets, uint256 repaidUnits, address borrower, bytes data) {
    bytes32 id;
    bool isHealthyBefore = isHealthyExternal(e, obligation, id, borrower);
